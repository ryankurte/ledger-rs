use std::{net::{IpAddr, SocketAddr, Ipv4Addr}, ops::Deref, time::Duration, num::ParseIntError, str::FromStr};

use byteorder::{ByteOrder, NetworkEndian};
use ledger_transport::{Exchange, APDUCommand, APDUAnswer};
...
impl TransportTcp {
    ...
    pub async fn new(o: TcpOptions) -> Result<Self, Error> {
        ...
        // Build object
        Ok(Self{ s: Mutex::new(s), timeout: Duration::from_millis(o.timeout_ms) })
    }
}
...
impl Exchange for TransportTcp {
        ...
        I: Deref<Target = [u8]> + Send + Sync,
    {
        ...
        // Decode answer ADPU
        let answer = APDUAnswer::from_answer(buff)
